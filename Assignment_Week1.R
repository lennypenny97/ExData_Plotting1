...
# Assignment - Week 1 - lennypenny97
...
# Plot 2 - Global active power - Frequency per days
...
# Plot 4 - Global active power/Voltage/Energy sub metering/Global reactive power 4x4 plot
